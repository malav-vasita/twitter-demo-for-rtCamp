<?php
/**
 * This file  is error 401 file for twitter demo.
 * 
 * PHP version 5.4
 * 
 * @category PHP
...
<html lang="en">
    ...
    <head>
        ...
        <title>Unauthorized access | Twitter timeline challange | rtCamp</title>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="intro-message">
                            <h1>401</h1>
                            <h3>Unauthorized Access Detected!</h3>
                            <hr class="intro-divider">
                            <ul class="list-inline intro-social-buttons">
                                <li>
                                    <a href="index" 
                                       class="btn btn-default btn-lg"> 
    <span class="network-name">Go Back To Home</span>
